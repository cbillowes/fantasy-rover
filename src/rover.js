 ...
 * @param {string} bounds - Terrain bounds: The zones have been very carefully surveyed ahead of time and are deemed
 ...
 * back to HQ.
 */
export function move(bounds, location, commands) {
    ...
    setOfCommands.forEach(command => {
        destination = _command.execute(coords, cardinal, command);
